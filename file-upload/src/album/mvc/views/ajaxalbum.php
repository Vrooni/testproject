<?php foreach ($album as $photo): ?>
  <div class="card col col-3">
    <img class="card-img-top" src="../../../../../testproject/file-upload/src/uploads/<?php echo $photo->cover ?>" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title"><?php echo html($photo->name) ?></h5>
      <p class="card-text"><?php echo html($photo->descr) ?></p>
      <a href="#" class="btn btn-primary mt-3">Zum Album</a>
      <a href="/Albumsettings?id=<?php echo $photo->id ?>" class="btn btn-secondary mt-3">Settings</a>
    </div>
  </div>
<?php endforeach ?>
...
<script src="´../../../../../testproject/file-upload/src/album/ajax/CreateAlbum.js"></script>