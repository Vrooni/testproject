...
try {
  if ($request == "/testproject/photo-album2/") {
  ...
  } elseif ($request == "/Albumsettings") {
    $router->add("album_controller", "settings");
  } elseif ($request == "/Albumsettings-updateAlbum") {
    $router->add("album_controller", "ajaxUpdateAlbum");
    $router->add("album_controller", "ajaxSettingsPage");
  } else {
