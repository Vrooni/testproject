<?php foreach ($album as $photo): ?>
  <div class="card col col-3">
    <img class="card-img-top" src="../../../../../testproject/mails/src/uploads/<?php echo $photo->cover ?>" alt="Card image cap">
    <div class="card-body">
...
<script src="´../../../../../testproject/mails/src/album/ajax/CreateAlbum.js"></script>